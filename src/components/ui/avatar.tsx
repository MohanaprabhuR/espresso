...
const textSizeMap: Record<string, string> = {
  xs: "text-2xs font-var-500 text-accent-foreground",
  sm: "text-sm font-var-500 text-accent-foreground",
  md: "text-base font-var-500 text-accent-foreground",
  lg: "text-base font-var-500 text-accent-foreground",
  xl: "text-lg font-var-500 text-accent-foreground",
  "2xl": "text-xl font-var-500-30 text-accent-foreground",
  "3xl": "text-2xl font-var-500-30 text-accent-foreground",
};
...
const statusIconMap: Record<Status, React.ReactNode> = {
  active: (
    ...
    >
      <circle cx="8.5" cy="8" r="8" fill="#137949" />
    </svg>
  ),
  away: (
    // <Image src="/images/status-away.png" alt="Away" width={12} height={12} />
  ...
  sleep: (
    // <Image src="/images/status-sleep.png" alt="Sleep" width={12} height={12} />
    <svg
      width="17"
      height="16"
      viewBox="0 0 17 16"
  ...
  close: (
    ...
    // <Image src="/images/status-close.png" alt="Close" width={12} height={12} />
  ),
  checked: (
    // <Image
    //   src="/images/status-checked.png"
    //   alt="Checked"
    //   width={12}
    //   height={12}
    // />
  ...
  pin: (
    // <Image src="/images/status-pin.png" alt="Pin" width={12} height={12} />
    <svg
      width="13"
      height="12"
      viewBox="0 0 13 12"
        ...
        {status && (
          <span
            className={cn(
              ...
              {
                "bg-green-500 p-[3px]": status === "checked",
                "bg-red-500 p-[2px]": status === "close",
                "bg-blue-500 p-[1px]": status === "pin",
                "size-[4px]": size === "xs",
                "size-[5px]": size === "sm",
                "size-[7px]": size === "md",
